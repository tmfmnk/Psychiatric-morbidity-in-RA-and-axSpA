...
all_matched_sampled_pairs <- map2(first_hospitalizations_rheuma_no_chronic_disorder_1999_2012,
                                  ...
                                  function(data_rheuma_dg, rheuma_codes) {
                                    ...
                                    hospitalizations_unexp_1999_2012 <- hospitalizations_1994_2017  %>%
                                      filter(year(ymd(DATPRI)) >= 1999 & year(ymd(DATUKO)) <= 2012) %>%
                                      filter(grepl("^I25|^I50|^E11|^J4[1-4]|^J45|^N03|^N11|^N1[8-9]|^N80|^K760|^M8[0-2]|^G4[0-1]|^G2[0-2]", ZDG) |
                                               grepl("^I25|^I50|^E11|^J4[1-4]|^J45|^N03|^N11|^N1[8-9]|^N80|^K760|^M8[0-2]|^G4[0-1]|^G2[0-2]", DDG2) |
                                               grepl("^I25|^I50|^E11|^J4[1-4]|^J45|^N03|^N11|^N1[8-9]|^N80|^K760|^M8[0-2]|^G4[0-1]|^G2[0-2]", DDG3) |
                                               grepl("^I25|^I50|^E11|^J4[1-4]|^J45|^N03|^N11|^N1[8-9]|^N80|^K760|^M8[0-2]|^G4[0-1]|^G2[0-2]", DDG4) |
                                               grepl("^I25|^I50|^E11|^J4[1-4]|^J45|^N03|^N11|^N1[8-9]|^N80|^K760|^M8[0-2]|^G4[0-1]|^G2[0-2]", DDG5)) %>%
                                      filter(!grepl(rheuma_codes, ZDG) & 
                                               !grepl(rheuma_codes, DDG2) & 
                                               !grepl(rheuma_codes, DDG3) & 
                                               !grepl(rheuma_codes, DDG4) & 
...
map2_dfr(.x = imap(first_hospitalizations_rheuma_no_chronic_disorder_1999_2012,
  ...
  write.csv(file = "path/AZV_rheuma_risk_of_psych_hosp/Results/Unmatched_n_chronic_disease_comparison.csv",
            row.names = FALSE)
...
data_chronic_disease_comparison <- map(cohorts_baseline_with_outcome,
                                       function(data_rheuma_dg) {
...
save(data_chronic_disease_comparison, 
     file = "path/AZV_rheuma_risk_of_psych_hosp/Data/data_chronic_disease_comparison.RData")